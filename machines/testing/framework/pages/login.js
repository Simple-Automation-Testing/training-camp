class LoginPage {
    ...
    async checkIn(username, name, email, password) {
        await this.page.fill(LoginPage.CHECKIN_FORM_USERNAME_FIELD, username);
        await this.page.fill(LoginPage.CHECKIN_FORM_NAME_FIELD, name);
        await this.page.fill(LoginPage.CHECKIN_FORM_EMAIL_FIELD, email);
        await this.page.fill(LoginPage.CHECKIN_FORM_PASSWORD_FIELD, password);
        await (await this.page.$(LoginPage.CHECKIN_FORM_REGISTER_BUTTON)).click();
    }

    async login(name, password) {
        await this.page.fill(LoginPage.LOGIN_FORM_USER_NAME_FIELD, name);
        await this.page.fill(LoginPage.LOGIN_FORM_PASSWORD_FIELD, password);
